...
public class LecturesResourceTest {
  ...
  public void shouldAdd() {
    ...
    Integer createdObjectId = RestUtils.postObject("/lectures", authorizationHeader, create);

    given().contentType(ContentType.JSON)
        .header(authorizationHeader)
        .when()
        .get("/lectures/" + createdObjectId)
        .then()
        .statusCode(200)
        .body("name", equalTo("1"))
        .body("url", equalTo("2"))
  ...
  public void shouldList() {
    ...
    RestUtils.postObject("/lectures", authorizationHeader, create);
    ...
    given().contentType(ContentType.JSON)
        ...
        .then()
        .statusCode(200)
        .body("_embedded.lectures.name[0]", equalTo("1"))
        .body("_embedded.lectures.url[0]", equalTo("2"));
  }
  ...
  public void shouldNotListForeign() {
    ...
    given().contentType(ContentType.JSON)
        ...
        .then()
        .statusCode(200)
        .body("_embedded.lectures", hasSize(0));
  }
  ...
  public void shouldDelete() {
    ...
    given().contentType(ContentType.JSON)
        .header(authorizationHeader)
        .when()
        .delete("/lectures/" + createdObjectId)
        .then()
        .statusCode(204);
