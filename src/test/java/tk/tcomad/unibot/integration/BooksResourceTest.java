...
public class BooksResourceTest {
  ...
  public void shouldAdd() {
    ...
    Integer createdObjectId = RestUtils.postObject("/books", authorizationHeader, create);

    given().contentType(ContentType.JSON)
        .header(authorizationHeader)
        .when()
        .get("/books/" + createdObjectId)
        .then()
        .statusCode(200)
        .body("name", equalTo("1"))
        .body("url", equalTo("2"))
  ...
  public void shouldList() {
    ...
    RestUtils.postObject("/books", authorizationHeader, create);
    ...
    given().contentType(ContentType.JSON)
        ...
        .then()
        .statusCode(200)
        .body("_embedded.books.name[0]", equalTo("1"))
        .body("_embedded.books.url[0]", equalTo("2"));
  }
  ...
  public void shouldNotListForeign() {
    ...
    given().contentType(ContentType.JSON)
        ...
        .then()
        .statusCode(200)
        .body("_embedded.books", hasSize(0));
  }
