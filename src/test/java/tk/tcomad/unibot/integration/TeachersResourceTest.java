...
public class TeachersResourceTest {
  ...
  public void shouldAdd() {
    ...
    Integer createdObjectId = RestUtils.postObject("/teachers", authorizationHeader, create);

    given().contentType(ContentType.JSON)
        .header(authorizationHeader)
        .when()
        .get("/teachers/" + createdObjectId)
        .then()
        .statusCode(200)
        .body("name", equalTo("1"))
        .body("data", equalTo("2"))
  ...
  public void shouldList() {
    ...
    RestUtils.postObject("/teachers", authorizationHeader, create);
    ...
    given().contentType(ContentType.JSON)
        ...
        .then()
        .statusCode(200)
        .body("_embedded.teachers.name[0]", equalTo("1"))
        .body("_embedded.teachers.data[0]", equalTo("2"));
  }
  ...
  public void shouldNotListForeign() {
    ...
    given().contentType(ContentType.JSON)
        ...
        .then()
        .statusCode(200)
        .body("_embedded.teachers", hasSize(0));
  }
  ...
  public void shouldDelete() {
    ...
    given().contentType(ContentType.JSON)
        .header(authorizationHeader)
        .when()
        .delete("/teachers/" + createdObjectId)
        .then()
        .statusCode(204);
